  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        {selectedChannel && (
          <div style={{ marginBottom: '2rem', borderRadius: '0.5rem', overflow: 'hidden', backgroundColor: 'rgb(17, 24, 39)' }}>
            <div style={{ padding: '1rem', backgroundColor: 'rgb(31, 41, 55)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'rgb(156, 163, 175)', fontSize: '0.875rem' }}>
        ...
        <div style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: 'rgb(31, 41, 55)', borderRadius: '0.5rem' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: 'bold', marginBottom: '1rem' }}>Find Channels</h3>
        ...
        {loading ? (
          ...
          <div style={{ backgroundColor: 'rgb(31, 41, 55)', padding: '2rem', borderRadius: '0.5rem', textAlign: 'center' }}>
            <p style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>No channels found</p>
            <p style={{ color: 'rgb(156, 163, 175)' }}>Try adjusting your search or filters</p>
          </div>
        ) : (
          <div>
